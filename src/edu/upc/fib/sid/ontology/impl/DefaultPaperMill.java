...
import edu.upc.fib.sid.ontology.interfaces.PaperMill;
import edu.upc.fib.sid.ontology.interfaces.WaterTank;
import jade.util.leap.*;

/**
* Protege name: http://www.semanticweb.org/josepdecidrodriguez/ontologies/2018/5/untitled-ontology-17#PaperMill
* @author OntologyBeanGenerator v4.1
* @version 2018/06/19, 11:47:03
*/
public class DefaultPaperMill implements PaperMill, Serializable {
   // bean stuff
  ...
  public DefaultPaperMill() {
    this._internalInstanceName = "";
  }

  public DefaultPaperMill(String instance_name) {
