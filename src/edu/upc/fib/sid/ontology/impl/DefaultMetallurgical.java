...
import edu.upc.fib.sid.ontology.interfaces.Metallurgical;
import edu.upc.fib.sid.ontology.interfaces.WaterTank;
import jade.util.leap.*;

/**
* Protege name: http://www.semanticweb.org/josepdecidrodriguez/ontologies/2018/5/untitled-ontology-17#Metallurgical
* @author OntologyBeanGenerator v4.1
* @version 2018/06/19, 11:47:03
*/
public class DefaultMetallurgical implements Metallurgical, Serializable {
   // bean stuff
  ...
  public DefaultMetallurgical() {
    this._internalInstanceName = "";
  }

  public DefaultMetallurgical(String instance_name) {
