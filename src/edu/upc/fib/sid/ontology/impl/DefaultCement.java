...
import edu.upc.fib.sid.ontology.interfaces.Cement;
import edu.upc.fib.sid.ontology.interfaces.WaterTank;
import jade.util.leap.*;

/**
* Protege name: http://www.semanticweb.org/josepdecidrodriguez/ontologies/2018/5/untitled-ontology-17#Cement
* @author OntologyBeanGenerator v4.1
* @version 2018/06/19, 11:47:03
*/
public class DefaultCement implements Cement, Serializable {
   // bean stuff
  ...
  public DefaultCement() {
    this._internalInstanceName = "";
  }

  public DefaultCement(String instance_name) {
