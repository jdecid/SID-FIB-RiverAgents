...
import edu.upc.fib.sid.ontology.interfaces.Textile;
import edu.upc.fib.sid.ontology.interfaces.WaterTank;
import jade.util.leap.*;

/**
* Protege name: http://www.semanticweb.org/josepdecidrodriguez/ontologies/2018/5/untitled-ontology-17#Textile
* @author OntologyBeanGenerator v4.1
* @version 2018/06/19, 11:47:03
*/
public class DefaultTextile implements Textile, Serializable {
   // bean stuff
  ...
  public DefaultTextile() {
    this._internalInstanceName = "";
  }

  public DefaultTextile(String instance_name) {
