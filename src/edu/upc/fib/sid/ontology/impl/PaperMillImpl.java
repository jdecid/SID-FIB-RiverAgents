...
import edu.upc.fib.sid.ontology.ifaces.PaperMill;
...
public class PaperMillImpl implements PaperMill, Serializable {
    ...
    public PaperMillImpl() {
        this._internalInstanceName = "";
    }

    public PaperMillImpl(String instance_name) {
